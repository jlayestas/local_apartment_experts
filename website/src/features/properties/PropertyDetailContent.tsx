...
export default function PropertyDetailContent({ property, similar, whatsappHref, availableLabel, fullAddress }: Props) {
  const { t } = useLanguage();
  ...
  const whatsappMessage = t("wa.property", { title: property.title });
        ...
        <div className="mt-5 flex items-center justify-between rounded-xl border border-gray-200 bg-white px-5 py-4 shadow-sm lg:hidden">
          ...
          {whatsappHref && (
            <a
              ...
              className="flex shrink-0 items-center gap-1.5 rounded-lg bg-green-500 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-green-600"
            >
