...
public record CreatePropertyRequest(
        ...
        /** If omitted, the service generates a slug from the title. */
        @Size(max = 200, message = "Slug must not exceed 200 characters")
        @Pattern(regexp = "^[a-z0-9]([a-z0-9-]*[a-z0-9])?$",
                 message = "Slug may only contain lowercase letters, digits, and hyphens, and must start/end with a letter or digit")
        String slug,
